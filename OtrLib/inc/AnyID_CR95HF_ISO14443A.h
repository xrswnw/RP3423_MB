#ifndef _ANYID_CR95HF_ISO14443A_
#define _ANYID_CR95HF_ISO14443A_
...
#define ISO14443A_AUTH_TIME                 20000
...
typedef struct iso14443aAuthframe{
    u16 frame[ISO14443A_MAX_FRAME_LEN];
    u8 length;
}ISO14443A_AUTHFRAME;
extern ISO14443A_AUTHFRAME g_sISO14443AAuthFrame;

u16 ISO14443A_GetOdd(u8 dat);
BOOL ISO14443A_CheckParity(u16 *pFrame, u8 len);
void ISO14443A_InitAuth(u64 key, u32 seed, u8 *pUid);
u8 ISO14443A_Mifare1Auth(ISO14443A_UID *pUID, u8 *pPassword, u8 addr, u8 authMode);
...
#define ISO14443A_ACK_TRS_ERROR        0x05
//存储区操作
//注意:符合ISO14443A协议的标签有很多种，但是标签的存储区的格式并不是一致的
//     有些标签操作需要密码，有些标签操作时却不需要密码
//     有些存储区的划分是4个字节一个page，而有些标签是16个字节一个block，64个字节一个sector
