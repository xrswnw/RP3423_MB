#ifndef _ANYID_ST25R391X_
#define _ANYID_ST25R391X_

#ifdef _ANYID_D3231_
    #include "AnyID_M345_ST25R391x_HL.h"
#elif (defined(_ANYID_M3225_))
    #include "AnyID_M345_ST25R391x_HL.h"
#elif (defined(_ANYID_FR328_) || defined(_ANYID_FR3211_) || defined(_ANYID_FR326_))
    #include "AnyID_M345_ST25R391x_HL.h"
#elif (defined(_ANYID_M329_))
    #include "AnyID_M329_ST25R391x_HL.h"
#elif (defined(_ANYID_M3280_))
    #include "AnyID_M3280_ST25R391x_HL.h"
#elif (defined(_ANYID_FR321CO_))
...
//²Ù×÷Ä£Ê½
#define ST25R3916_MODE_MSK                                  (0xC0)
#define ST25R3916_MODE_WRITE                                (0x00)                      // ST25R3916 Operation Mode: Write                                
#define ST25R3916_MODE_READ                                 (0x40)                      // ST25R3916 Operation Mode: Read                                 
#define ST25R3916_MODE_CMD                                  (0xC0)                      // ST25R3916 Operation Mode: Direct Command                       
#define ST25R3916_MODE_WFIFO                                (0x80U)                        // ST25R3916 Operation Mode: FIFO Load                            
#define ST25R3916_MODE_RFIFO                                (0x9FU)                        // ST25R3916 Operation Mode: FIFO Read                            
#define ST25R3916_MODE_WPTA                                 (0xA0U)                        // ST25R3916 Operation Mode: Passive Target Memory A-Config Load  
#define ST25R3916_MODE_WPTF                                 (0xA8U)                        // ST25R3916 Operation Mode: Passive Target Memory F-Config Load  
#define ST25R3916_MODE_WPTTSN                               (0xACU)                        // ST25R3916 Operation Mode: Passive Target Memory TSN Load       
#define ST25R3916_MODE_RPTMEM                               (0xBFU)                        // ST25R3916 Operation Mode: Passive Target Memory Read           
...
#define ST25R3916_INT_REGS_LEN                                  4
...
#define ST25R3916_ERR_OK                                        (0U)  // no error occurred 
#define ST25R3916_ERR_NOMEM                                     (1U)  // not enough memory to perform the requested operation 
#define ST25R3916_ERR_BUSY                                      (2U)  // device or resource busy 
#define ST25R3916_ERR_IO                                        (3U)  // generic IO error 
#define ST25R3916_ERR_TIMEOUT                                   (4U)  // error due to timeout 
#define ST25R3916_ERR_REQUEST                                   (5U)  // invalid request or requested function can't be executed at the moment 
#define ST25R3916_ERR_NOMSG                                     (6U)  // No message of desired type 
#define ST25R3916_ERR_PARAM                                     (7U)  // Parameter error 
#define ST25R3916_ERR_SYSTEM                                    (8U)  // System error 
#define ST25R3916_ERR_FRAMING                                   (9U)  // Framing error 
#define ST25R3916_ERR_OVERRUN                                   (10U) // lost one or more received bytes 
#define ST25R3916_ERR_PROTO                                     (11U) // protocol error 
#define ST25R3916_ERR_INTERNAL                                  (12U) // Internal Error 
#define ST25R3916_ERR_AGAIN                                     (13U) // Call again 
#define ST25R3916_ERR_MEM_CORRUPT                               (14U) // memory corruption 
#define ST25R3916_ERR_NOT_IMPLEMENTED                           (15U) // not implemented 
#define ST25R3916_ERR_PC_CORRUPT                                (16U) // Program Counter has been manipulated or spike/noise trigger illegal operation 
#define ST25R3916_ERR_SEND                                      (17U) // error sending
#define ST25R3916_ERR_IGNORE                                    (18U) // indicates error detected but to be ignored 
#define ST25R3916_ERR_SEMANTIC                                  (19U) // indicates error in state machine (unexpected cmd) 
#define ST25R3916_ERR_SYNTAX                                    (20U) // indicates error in state machine (unknown cmd) 
#define ST25R3916_ERR_CRC                                       (21U) // crc error  
#define ST25R3916_ERR_NOTFOUND                                  (22U) // transponder not found  
#define ST25R3916_ERR_NOTUNIQUE                                 (23U) // transponder not unique - more than one transponder in field  
#define ST25R3916_ERR_NOTSUPP                                   (24U) // requested operation not supported  
#define ST25R3916_ERR_WRITE                                     (25U) // write error  
#define ST25R3916_ERR_FIFO                                      (26U) // fifo over or underflow error  
#define ST25R3916_ERR_PAR                                       (27U) // parity error  
#define ST25R3916_ERR_DONE                                      (28U) // transfer has already finished 
#define ST25R3916_ERR_RF_COLLISION                              (29U) // collision error (Bit Collision or during RF Collision avoidance ) 
#define ST25R3916_ERR_HW_OVERRUN                                (30U) // lost one or more received bytes 
#define ST25R3916_ERR_RELEASE_REQ                               (31U) // device requested release 
#define ST25R3916_ERR_SLEEP_REQ                                 (32U) // device requested sleep 
#define ST25R3916_ERR_WRONG_STATE                               (33U) // incorrent state for requested operation 
#define ST25R3916_ERR_MAX_RERUNS                                (34U) // blocking procedure reached maximum runs 
#define ST25R3916_ERR_DISABLED                                  (35U) // operation aborted due to disabled configuration  
#define ST25R3916_ERR_HW_MISMATCH                               (36U) // expected hw do not match  
#define ST25R3916_ERR_LINK_LOSS                                 (37U) // Other device's field didn't behave as expected: turned off by Initiator in Passive mode, or AP2P did not turn on field 
#define ST25R3916_ERR_INVALID_HANDLE                            (38U) // invalid or not initalized device handle 

#define ST25R3916_ERR_INCOMPLETE_BYTE                           (40U) // Incomplete byte rcvd         
#define ST25R3916_ERR_INCOMPLETE_BYTE_01                        (41U) // Incomplete byte rcvd - 1 bit     
#define ST25R3916_ERR_INCOMPLETE_BYTE_02                        (42U) // Incomplete byte rcvd - 2 bit 
#define ST25R3916_ERR_INCOMPLETE_BYTE_03                        (43U) // Incomplete byte rcvd - 3 bit 
#define ST25R3916_ERR_INCOMPLETE_BYTE_04                        (44U) // Incomplete byte rcvd - 4 bit 
#define ST25R3916_ERR_INCOMPLETE_BYTE_05                        (45U) // Incomplete byte rcvd - 5 bit 
#define ST25R3916_ERR_INCOMPLETE_BYTE_06                        (46U) // Incomplete byte rcvd - 6 bit 
#define ST25R3916_ERR_INCOMPLETE_BYTE_07                        (47U) // Incomplete byte rcvd - 7 bit 

#define St25r3916_CloseAntenna()                                St25r3916_ClearRegBits(ST25R3916_REG_OP_CONTROL,  ST25R3916_REG_OP_CONTROL_tx_en | ST25R3916_REG_OP_CONTROL_rx_en);
#define St25r3916_OpenAntenna()                                 St25r3916_SetRegBits(ST25R3916_REG_OP_CONTROL, ST25R3916_REG_OP_CONTROL_tx_en | ST25R3916_REG_OP_CONTROL_rx_en, ST25R3916_REG_OP_CONTROL_tx_en | ST25R3916_REG_OP_CONTROL_rx_en)                               
#define St25r3916_FlushFifo()                                   St25r3916_WriteCmd(ST25R3916_CMD_CLEAR_FIFO)

#define ST25R3916_FRAME_LEN                                     64
typedef struct st25r3916Frame{
    u8 frame[ST25R3916_FRAME_LEN];
    u8 txLen;
    u8 rxLen;
    u8 txCrc;
    u8 rxCrc;
...
extern ST25R3916_FRAME g_sSt25r3916Frame;
