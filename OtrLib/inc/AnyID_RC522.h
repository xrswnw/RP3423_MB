...
#define     RC522_STAT_OK                0x00   //正确
#define     RC522_STAT_INIT_ERROR        0x01   //系统初始化错误
#define     RC522_STAT_CMD_ERROR         0x02   //错误的RC522命令
#define     RC522_STAT_TIMEOUT           0x03   //RC522命令执行超时
#define     RC522_STAT_COLLISION_ERROR   0x04   //碰撞错误 STATUS_RC522_TEMP_ERROR
#define     RC522_STAT_PARITY_ERROR      0x05   //校验错误
#define     RC522_STAT_PROTOCOL_ERROR    0x06   //协议错误
#define     RC522_STAT_FIFOOF_ERROR      0x07   //FIFO溢出
#define     RC522_STAT_CRC_ERROR         0x08   //CRC错误
#define     RC522_STAT_TEMP_ERROR        0x09   //温度过高
#define     RC522_STAT_WFIFO_ERROR       0x0A   //写FIFO错误
#define     RC522_STAT_ACK               0x0B   //ASK
#define     RC522_STAT_ERROR             0x0C   //错误
#define     RC522_STAT_PICC_TYPE_ERROR   0x0D   //PICC类型不存在
#define     RC522_STAT_AUTH_ERROR        0x0F   //授权认证错误
#define     RC522_STAT_TRANS_ERROR       0x10   //传输错误
#define     RC522_STAT_BCC_ERROR         0x11   //BCC错误
#define     RC522_STAT_NAK               0x12   //BCC错误
#define     RC522_STAT_AUTHM0U2_ERR      0x13   //ultralightC授权错误
