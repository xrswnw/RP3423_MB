#ifndef _ANYID_RC663_ISO15693_
#define _ANYID_RC663_ISO15693_

#include "AnyID_RC663.h"

extern BOOL g_bDoubleCarry;

#define ISO15693_MAX_FRAME_LEN                  RC663_FRAME_LEN
...
#define ISO15693_CMD_FST_RMBLK                  0xA5
...
#define ISO15693_TAG_TYPE_FM                    0x1D
...
#if (defined(_ANYID_M328_) || defined(_ANYID_M329_))
    #define ISO15693_INVENTORY_TIME                 7000
    #define ISO15693_READ_TIME                      ISO15693_INVENTORY_TIME
    #define ISO15693_WRITE_TIME                     25000
    #define ISO15693_OP_TIME                        25000
#elif (defined(_ANYID_STM32L0_))
    #define ISO15693_INVENTORY_TIME                 500 //330
    #define ISO15693_READ_TIME                      ISO15693_INVENTORY_TIME
    #define ISO15693_WRITE_TIME                     25000
    #define ISO15693_OP_TIME                        25000
#else
