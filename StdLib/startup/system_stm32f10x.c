...
/*!< Uncomment the line corresponding to the desired System clock (SYSCLK)
 ...
 #else
  #if (defined(_ANYID_BCTRL_) || defined(_ANYID_HSE12P00_))
   #define HSE_VALUE    ((uint32_t)12000000) /*!< Value of the External oscillator in Hz */
  #elif (defined(_ANYID_HSE13P56_) || defined(_ANYID_HMR100_) || defined(_ANYID_STBT100_) || defined(_ANYID_HLR600_) || defined(_ANYID_HSW300_) || defined(_ANYID_M330_))
     #define HSE_VALUE    ((uint32_t)13560000) /*!< Value of the External oscillator in Hz */
  #elif (defined(_ANYID_HSE11P06_))
     #define HSE_VALUE    ((uint32_t)11059200) /*!< Value of the External oscillator in Hz */
  #elif (defined(_ANYID_HSE24P00_))
     #define HSE_VALUE    ((uint32_t)24000000) /*!< Value of the External oscillator in Hz */
  #elif (defined(_ANYID_HSE6P78_))
     #define HSE_VALUE    ((uint32_t)6780000) /*!< Value of the External oscillator in Hz */
  #else
